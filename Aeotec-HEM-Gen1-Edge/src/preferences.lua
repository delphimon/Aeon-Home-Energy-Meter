...
local devices = {
    AEOTEC = {
		...
		--Need to do parameters 2 - think we should retrofit that depending on demand
			...
			g1RefreshInterval = {parameter_number = 111, size = 4}, -- done
			g2RefreshInterval = {parameter_number = 112, size = 4}, -- done
			g3RefreshInterval = {parameter_number = 113, size = 4}  -- done
        }
    }
}
